        ...
        <section id="display">
            ...
            <section id="display-main">
                ...
                <div id="display-extra">
                    ...
                    <p>Description: <span class="right-align">{itemObject.item.desc}</span></p>
                    <p>Humidity: <span class="right-align">{itemObject.item.humid}%</span></p>
                    <p>Wind Speed: <span class="right-align">{itemObject.item.wind}m/s</span></p>
                </div>
